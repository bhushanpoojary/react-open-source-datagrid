 ...
 */
const getFilterOperationType = (filter) => {
    if (filter.type === 'set' || filter.type === 'in' || filter.type === 'notIn' || filter.values)
        return 'set';
 ...
 */
const applySingleCondition = (row, field, condition) => {
 ...
 */
const applyAdvancedFilter = (row, field, filter) => {
 ...
 */
const applyFilter = (row, field, filter) => {
    if (!filter)
        return true;
 ...
 */
export const applyFilters = (rows, filterConfig) => {
 ...
 */
export const getActiveFilterCount = (filterConfig) => {
