 ...
 */
export const computeAggregations = (rows, aggregateConfigs) => {
    const result = {};
 ...
 */
export const computeGroupAggregations = (groupedRows, aggregateConfigs) => {
 ...
 */
export const formatAggregateValue = (value, func) => {
    if (value === null)
        return '-';
    switch (func) {
        case 'count':
 ...
 */
export const getAggregateLabel = (func) => {
    switch (func) {
        case 'count':
            return 'Count';
        case 'sum':
