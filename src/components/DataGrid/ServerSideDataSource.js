...
export class ServerSideDataSource {
     ...
     */
    purgeCache() {
        if (this.blockCache.size <= this.cacheBlockCount)
            return;
 ...
 */
export function createMockServerDataSource(totalRows = 1000000, delay = 300) {
