...
const orgChartColumns = [
    {
        field: 'name',
        headerName: 'Name',
        width: 250,
        sortable: true,
        renderCell: (row) => (_jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: '8px' }, children: [_jsx("span", { style: {
                        fontSize: '16px',
                        filter: 'grayscale(0.2)',
                    }, children: "\uD83D\uDC64" }), _jsx("span", { style: { fontWeight: row.level === 0 ? 600 : 400 }, children: row.name })] }))
    },
...
const fileExplorerColumns = [
    {
        ...
        width: 300,
        sortable: true,
        renderCell: (row) => (_jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: '8px' }, children: [_jsx("span", { style: { fontSize: '16px' }, children: row.type === 'folder' ? '📁' : '📄' }), _jsx("span", { children: row.name })] }))
    },
...
const productCategoriesColumns = [
    {
        ...
        width: 280,
        sortable: true,
        renderCell: (row) => (_jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: '8px' }, children: [_jsx("span", { style: { fontSize: '16px' }, children: row.level === 0 ? '📦' : row.level === 1 ? '📂' : '📄' }), _jsx("span", { style: {
    ...
    },
    {
        ...
        width: 120,
        sortable: true,
        renderCell: (row) => (_jsx("span", { style: {
                fontWeight: 500,
                color: '#6b7280',
    ...
    },
    {
        ...
        width: 150,
        sortable: true,
        renderCell: (row) => (_jsxs("span", { style: {
                fontWeight: 600,
                color: '#16a34a',
                display: 'flex',
                alignItems: 'center',
                gap: '4px',
            }, children: [_jsx("span", { style: { fontSize: '12px', opacity: 0.8 }, children: "$" }), row.revenue?.toLocaleString()] }))
    },
];
export const TreeDataDemo = () => {
    const [selectedDemo, setSelectedDemo] = useState('orgChart');
    const treeConfig = {
        enabled: true,
        idField: 'id',
    ...
    return (_jsxs("div", { style: { padding: '24px', maxWidth: '1400px', margin: '0 auto' }, children: [_jsx("style", { children: `
      ...
      ` }), _jsxs("div", { style: { marginBottom: '32px' }, children: [_jsx("h1", { style: { fontSize: '32px', fontWeight: 'bold', marginBottom: '8px', color: '#1f2937' }, children: "\uD83C\uDF32 Tree Data / Hierarchical Rows" }), _jsx("p", { style: { fontSize: '16px', color: '#6b7280', marginBottom: '24px' }, children: "Display hierarchical data with expand/collapse functionality, smooth animations, and visual indentation." }), _jsx("div", { style: { display: 'flex', gap: '12px', flexWrap: 'wrap' }, children: [
                            { id: 'orgChart', label: '📊 Org Chart', color: '#3b82f6' },
                            { id: 'fileExplorer', label: '📁 File Explorer', color: '#8b5cf6' },
                            { id: 'productCategories', label: '🏷️ Product Categories', color: '#10b981' },
                        ].map((demo) => (_jsx("button", { onClick: () => setSelectedDemo(demo.id), style: {
                                padding: '12px 24px',
                                borderRadius: '8px',
                            ...
                            }, children: demo.label }, demo.id))) })] }), _jsxs("div", { style: {
                    backgroundColor: '#f0f9ff',
                    border: '1px solid #bae6fd',
                    borderRadius: '8px',
                    padding: '16px',
                    marginBottom: '24px'
                }, children: [_jsx("h2", { style: { fontSize: '20px', fontWeight: 600, marginBottom: '8px', color: '#0c4a6e' }, children: config.title }), _jsx("p", { style: { fontSize: '14px', color: '#0369a1', marginBottom: '12px' }, children: config.description }), _jsxs("div", { style: { display: 'flex', gap: '16px', fontSize: '13px', color: '#075985' }, children: [_jsx("span", { children: "\u2713 Expand/collapse controls" }), _jsx("span", { children: "\u2713 Visual indentation" }), _jsx("span", { children: "\u2713 Hierarchical relationships" }), _jsx("span", { children: "\u2713 All DataGrid features supported" })] })] }), _jsx("div", { className: "tree-demo-card", style: {
                    backgroundColor: 'white',
                    borderRadius: '12px',
                    boxShadow: '0 4px 6px -1px rgba(0,0,0,0.1), 0 2px 4px -1px rgba(0,0,0,0.06)',
                    overflow: 'hidden',
                    border: '1px solid #e5e7eb',
                }, children: _jsx(DataGrid, { columns: config.columns, rows: config.data, pageSize: 20, treeConfig: treeConfig, theme: "quartz", onRowClick: (row) => console.log('Row clicked:', row) }) }), _jsxs("div", { style: { marginTop: '40px', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '24px' }, children: [_jsxs("div", { style: { padding: '20px', backgroundColor: '#f9fafb', borderRadius: '8px', border: '1px solid #e5e7eb' }, children: [_jsx("h3", { style: { fontSize: '18px', fontWeight: 600, marginBottom: '12px', color: '#1f2937' }, children: "\uD83C\uDFAF Key Features" }), _jsxs("ul", { style: { fontSize: '14px', color: '#4b5563', lineHeight: '1.8', paddingLeft: '20px' }, children: [_jsx("li", { children: "Automatic tree structure from flat data" }), _jsx("li", { children: "Expand/collapse functionality per node" }), _jsx("li", { children: "Visual indentation based on level" }), _jsx("li", { children: "Configurable indent size" }), _jsx("li", { children: "Custom expand icons" })] })] }), _jsxs("div", { style: { padding: '20px', backgroundColor: '#f9fafb', borderRadius: '8px', border: '1px solid #e5e7eb' }, children: [_jsx("h3", { style: { fontSize: '18px', fontWeight: 600, marginBottom: '12px', color: '#1f2937' }, children: "\uD83D\uDD27 Configuration" }), _jsxs("ul", { style: { fontSize: '14px', color: '#4b5563', lineHeight: '1.8', paddingLeft: '20px' }, children: [_jsx("li", { children: "Specify parent-child relationships" }), _jsx("li", { children: "Control initial expansion state" }), _jsx("li", { children: "Customize field mappings" }), _jsx("li", { children: "Optional lazy loading support" }), _jsx("li", { children: "Event handlers for expand/collapse" })] })] }), _jsxs("div", { style: { padding: '20px', backgroundColor: '#f9fafb', borderRadius: '8px', border: '1px solid #e5e7eb' }, children: [_jsx("h3", { style: { fontSize: '18px', fontWeight: 600, marginBottom: '12px', color: '#1f2937' }, children: "\uD83D\uDCA1 Use Cases" }), _jsxs("ul", { style: { fontSize: '14px', color: '#4b5563', lineHeight: '1.8', paddingLeft: '20px' }, children: [_jsx("li", { children: "Organization charts" }), _jsx("li", { children: "File system browsers" }), _jsx("li", { children: "Product category trees" }), _jsx("li", { children: "Comment threads" }), _jsx("li", { children: "Task hierarchies" })] })] })] }), _jsxs("div", { style: { marginTop: '40px' }, children: [_jsx("h3", { style: { fontSize: '20px', fontWeight: 600, marginBottom: '16px', color: '#1f2937' }, children: "Quick Example" }), _jsx(CodeBlock, { title: "Tree Data Configuration", language: "tsx", code: `import { DataGrid} from './components/DataGrid';
